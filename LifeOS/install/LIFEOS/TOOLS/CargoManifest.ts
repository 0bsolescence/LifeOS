 ...
 * {
 *   "node": "<hostname>",
 *   "from_node": "<hostname>",            // optional; defaults to node
...
// this estate, and both races lose records:
//
 ...
 * is the exact shadowing this lifecycle exists to prevent.
 *
 ...
 * hide it forever. Frontmatter `created` is written
 ...
 * published in the claimed one's millisecond.
 */
...
function eligibleOpen(all: Handoff[]): Handoff[] {
  ...
  // touch must not decide which handoff wins.
