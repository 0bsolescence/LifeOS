---
last_updated: 2026-08-21T03:46:28.416Z
...
| **Bunker** | Universal application harness — concept adopted, reference implementation private upstream and NOT deployed here, so the Pulse /bunker tab is inert; the Security plane (Arbol infra-security scanner, server-side, hourly) runs regardless | `LIFEOS/DOCUMENTATION/LifeosSystemArchitecture.md` |
